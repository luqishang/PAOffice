...
#Region "private field"
	...
	Private _endRowIndex As Integer = 0
	Private _endColumnIndex As Integer = 0
#End Region
...
#Region "public property"
	...
	''' <summary>
	''' <see cref="PA.Office.ExcelReader.Load"/> で取得した行数を取得します。
	''' </summary>
	''' <value></value>
	''' <returns></returns>
	''' <remarks>
	''' <para>Excelから読み込んだ行数を取得します。この数値は <see cref="PA.Office.ExcelReader.SheetData"/> の row の最大値となります。</para>
	''' <para>なお、Loadメソッドで読み込み行数を指定したときは、その数値が登録されます。</para>	
	''' <para>Loadする前の値は0です。</para>	
	''' </remarks>
	Public ReadOnly Property EndRowIndex() As Integer
		Get
			Return Me._endRowIndex
		End Get
	End Property
	...
	''' <returns></returns>
	''' <remarks>
	''' <para>Excelから読み込んだ行数を取得します。この数値は <see cref="PA.Office.ExcelReader.SheetData"/> の column の最大値となります。</para>
	''' <para>Loadメソッドで読み込み列数を指定するので、その数値と必ず等しくなります。</para>	
	''' <para>Loadする前の値は0です。</para>	
	''' </remarks>
	Public ReadOnly Property EndColumnIndex() As Integer
		Get
			Return Me._endColumnIndex
		End Get
	End Property
...
#Region "public method"
	...
	Public Sub Load( _
		...
		Me._endColumnIndex = columnCount
		...
		Try
			...
			Me._endRowIndex = listRows.Count
